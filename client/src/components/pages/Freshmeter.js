...
const Freshmeter = () =>{
  return(
    <div className="App1">
      ...
      <p>Fresh Potatoes is for movie lovers and a resource for reccommendations and reviews.<br/> 
      We provide fans a place to share their opinions not only once, but twice! <br/>
      We give you a chance to give a rating and review prior to seeing a movie as well as after seeing the movie.<br/>
...
We call the ratings before users see the movie, Potatoes.<img src={potatoe} width="15px" /> 
        ...
        <br/><br/>
        After watching the movie, come back again to rate it based on how you actually liked it.<br/>
        In contrast to our Potatoes, we have our Fries<img src={fry} width="15px" />, ratings after users have seen the movie. 
        <br/>We have another page dedicated to the best Fries on our site. <br/>
        ...
        When you visit a movie’s page you are greeted by the poster, <br/>the trailer and a button with the 
        option to share the page. <br/>
        Below the title of the movie, you can see the genres, release date, runtime, <br/>
        and most importantly, how a movie rated before and after being seen. <br/>
        It’s a great gauge to see how the movie lived up to its expectations. <br/>
         Under the Overview, you can read the plot summary. 
         Under Movie Info you will find the Director and Cast. <br/><br/>
        Now the time has come, the moment you’ve been waiting for. 
        ...
        Select how many potatoes you expect to give this movie if you haven’t seen the movie, 
         or select that you’ve seen the movie to switch over to fries. Leave your comment, 
         make sure it’s witty to win internet points, 
         and submit your review. Now the internet knows that you have an opinion!
      </p>
    </div>
