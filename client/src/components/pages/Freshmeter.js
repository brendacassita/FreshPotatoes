...
<<<<<<< HEAD
      <p>
        ...
        <Link to={"/popular_potatoes"}>
          <b style={{ color: "red" }}>(Popular Potatoes)</b>
        </Link>
        .<br />
        ...
        <Link to={"/popular_fries"}>
          <b style={{ color: "red" }}>(Popular Fries)</b>
        </Link>
        ...
        <b style={{ color: "red" }}>potato</b>-rating! How good or bad do you
        think it will be? <br />
        Or select that you’ve seen the movie, and switch to a{" "}
        <b style={{ color: "red" }}>fry</b>-rating. <br />
...
>>>>>>> ba04810fcd7f3b0fba00bb47c9d8cc663af550c2
}
