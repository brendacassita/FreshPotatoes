...
u1 = User.create(email:'test1@test.com', password:123456, name:'TatorTot', username:'movielover1', avatar:'https://sdl-stickershop.line.naver.jp/products/0/0/1/1361417/android/stickers/14287245.png;compress=true', phone:'8018889888', role:'user')
...
u5 = User.create(email:'007@test.com', password:123456, name:'James Bond', username:'007', avatar:'https://sdl-stickershop.line.naver.jp/products/0/0/1/1361417/android/stickers/14287238.png;compress=true', phone:'801777777', role:'admin')
