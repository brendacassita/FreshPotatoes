...
action = Genre.create(name:'Action', image:'https://images2.minutemediacdn.com/image/upload/c_fill,w_720,ar_16:9,f_auto,q_auto,g_auto/shape/cover/sport/646987-jasin-boland-c-2012-warner-bros-entertainment-inc-54e2f8c553776eafbfd8ede11121a700.jpg')
adventure = Genre.create(name:'Adventure', image:'https://industrialscripts.com/wp-content/uploads/2021/08/Temple-of-Doom-Action-and-Adventure.jpg')
comedy = Genre.create(name:'Comedy', image:'https://assets.teenvogue.com/photos/61b0e8af915053e2749fc05d/master/w_2000,h_1125,c_limit/romy.jpeg')
